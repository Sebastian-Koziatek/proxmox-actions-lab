...
locals {
  all_vms = {
    1 = { name = "vmmonitoringclsz01", mac = "BC:24:11:F1:A2:01", ip = "10.123.1.76", vmid = 1076 }
    2 = { name = "vmmonitoringclsz02", mac = "BC:24:11:F1:A2:02", ip = "10.123.1.77", vmid = 1077 }
    3 = { name = "vmmonitoringclsz03", mac = "BC:24:11:F1:A2:03", ip = "10.123.1.78", vmid = 1078 }
    4 = { name = "vmmonitoringclsz04", mac = "BC:24:11:F1:A2:04", ip = "10.123.1.79", vmid = 1079 }
    5 = { name = "vmmonitoringclsz05", mac = "BC:24:11:F1:A2:05", ip = "10.123.1.80", vmid = 1080 }
    6 = { name = "vmmonitoringclsz06", mac = "BC:24:11:F1:A2:06", ip = "10.123.1.81", vmid = 1081 }
    7 = { name = "vmmonitoringclsz07", mac = "BC:24:11:F1:A2:07", ip = "10.123.1.82", vmid = 1082 }
    8 = { name = "vmmonitoringclsz08", mac = "BC:24:11:F1:A2:08", ip = "10.123.1.83", vmid = 1083 }
    9 = { name = "vmmonitoringclsz09", mac = "BC:24:11:F1:A2:09", ip = "10.123.1.84", vmid = 1084 }
    10 = { name = "vmmonitoringclsz10", mac = "BC:24:11:F1:A2:0A", ip = "10.123.1.85", vmid = 1085 }
    11 = { name = "vmmonitoringclsz11", mac = "BC:24:11:F1:A2:0B", ip = "10.123.1.86", vmid = 1086 }
    12 = { name = "vmmonitoringclsz12", mac = "BC:24:11:F1:A2:0C", ip = "10.123.1.87", vmid = 1087 }
    13 = { name = "vmmonitoringclsz13", mac = "BC:24:11:F1:A2:0D", ip = "10.123.1.88", vmid = 1088 }
    14 = { name = "vmmonitoringclsz14", mac = "BC:24:11:F1:A2:0E", ip = "10.123.1.89", vmid = 1089 }
    15 = { name = "vmmonitoringclsz15", mac = "BC:24:11:F1:A2:0F", ip = "10.123.1.90", vmid = 1090 }
  }
