...
locals {
  all_vms = {
    1 = { name = "vmmonitoringsz01", mac = "BC:24:11:F1:A1:01", ip = "10.123.1.61", vmid = 1061 }
    2 = { name = "vmmonitoringsz02", mac = "BC:24:11:F1:A1:02", ip = "10.123.1.62", vmid = 1062 }
    3 = { name = "vmmonitoringsz03", mac = "BC:24:11:F1:A1:03", ip = "10.123.1.63", vmid = 1063 }
    4 = { name = "vmmonitoringsz04", mac = "BC:24:11:F1:A1:04", ip = "10.123.1.64", vmid = 1064 }
    5 = { name = "vmmonitoringsz05", mac = "BC:24:11:F1:A1:05", ip = "10.123.1.65", vmid = 1065 }
    6 = { name = "vmmonitoringsz06", mac = "BC:24:11:F1:A1:06", ip = "10.123.1.66", vmid = 1066 }
    7 = { name = "vmmonitoringsz07", mac = "BC:24:11:F1:A1:07", ip = "10.123.1.67", vmid = 1067 }
    8 = { name = "vmmonitoringsz08", mac = "BC:24:11:F1:A1:08", ip = "10.123.1.68", vmid = 1068 }
    9 = { name = "vmmonitoringsz09", mac = "BC:24:11:F1:A1:09", ip = "10.123.1.69", vmid = 1069 }
    10 = { name = "vmmonitoringsz10", mac = "BC:24:11:F1:A1:0A", ip = "10.123.1.70", vmid = 1070 }
    11 = { name = "vmmonitoringsz11", mac = "BC:24:11:F1:A1:0B", ip = "10.123.1.71", vmid = 1071 }
    12 = { name = "vmmonitoringsz12", mac = "BC:24:11:F1:A1:0C", ip = "10.123.1.72", vmid = 1072 }
    13 = { name = "vmmonitoringsz13", mac = "BC:24:11:F1:A1:0D", ip = "10.123.1.73", vmid = 1073 }
    14 = { name = "vmmonitoringsz14", mac = "BC:24:11:F1:A1:0E", ip = "10.123.1.74", vmid = 1074 }
    15 = { name = "vmmonitoringsz15", mac = "BC:24:11:F1:A1:0F", ip = "10.123.1.75", vmid = 1075 }
  }
